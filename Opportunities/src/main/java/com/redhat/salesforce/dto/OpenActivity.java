...
public class OpenActivity extends AbstractSObjectBase {
    ...
    private OpenActivity_StatusEnum Status;

    @JsonProperty("Status")
    public OpenActivity_StatusEnum getStatus() {
        return this.Status;
    }

    @JsonProperty("Status")
    public void setStatus(OpenActivity_StatusEnum Status) {
        this.Status = Status;
    }

    // Priority
    @XStreamConverter(PicklistEnumConverter.class)
    private OpenActivity_PriorityEnum Priority;

    @JsonProperty("Priority")
    public OpenActivity_PriorityEnum getPriority() {
        return this.Priority;
    }

    @JsonProperty("Priority")
    public void setPriority(OpenActivity_PriorityEnum Priority) {
    ...
    // ActivityType
    @XStreamConverter(PicklistEnumConverter.class)
    private OpenActivity_ActivityTypeEnum ActivityType;

    @JsonProperty("ActivityType")
    public OpenActivity_ActivityTypeEnum getActivityType() {
        return this.ActivityType;
    }

    @JsonProperty("ActivityType")
    public void setActivityType(OpenActivity_ActivityTypeEnum ActivityType) {
    ...
    // CallType
    @XStreamConverter(PicklistEnumConverter.class)
    private OpenActivity_CallTypeEnum CallType;

    @JsonProperty("CallType")
    public OpenActivity_CallTypeEnum getCallType() {
        return this.CallType;
    }

    @JsonProperty("CallType")
    public void setCallType(OpenActivity_CallTypeEnum CallType) {
