...
public enum TaskFeed_TypeEnum {
    ...
    private TaskFeed_TypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static TaskFeed_TypeEnum fromValue(String value) {
        for (TaskFeed_TypeEnum e : TaskFeed_TypeEnum.values()) {
