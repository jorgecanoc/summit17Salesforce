...
public class ContentDocument extends AbstractSObjectBase {
    ...
    // ArchivedDate
    private java.time.ZonedDateTime ArchivedDate;

    @JsonProperty("ArchivedDate")
    public java.time.ZonedDateTime getArchivedDate() {
        return this.ArchivedDate;
    }

    @JsonProperty("ArchivedDate")
    public void setArchivedDate(java.time.ZonedDateTime ArchivedDate) {
