 ...
 */
public enum ContactShare_RowCauseEnum {
    ...
    private ContactShare_RowCauseEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static ContactShare_RowCauseEnum fromValue(String value) {
        for (ContactShare_RowCauseEnum e : ContactShare_RowCauseEnum.values()) {
