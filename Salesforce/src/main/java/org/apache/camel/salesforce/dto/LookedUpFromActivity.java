...
public class LookedUpFromActivity extends AbstractSObjectBase {
    ...
    private LookedUpFromActivity_StatusEnum Status;

    @JsonProperty("Status")
    public LookedUpFromActivity_StatusEnum getStatus() {
        return this.Status;
    }

    @JsonProperty("Status")
    public void setStatus(LookedUpFromActivity_StatusEnum Status) {
        this.Status = Status;
    }

    // Priority
    @XStreamConverter(PicklistEnumConverter.class)
    private LookedUpFromActivity_PriorityEnum Priority;

    @JsonProperty("Priority")
    public LookedUpFromActivity_PriorityEnum getPriority() {
        return this.Priority;
    }

    @JsonProperty("Priority")
    public void setPriority(LookedUpFromActivity_PriorityEnum Priority) {
    ...
    // ActivityType
    @XStreamConverter(PicklistEnumConverter.class)
    private LookedUpFromActivity_ActivityTypeEnum ActivityType;

    @JsonProperty("ActivityType")
    public LookedUpFromActivity_ActivityTypeEnum getActivityType() {
        return this.ActivityType;
    }

    @JsonProperty("ActivityType")
    public void setActivityType(LookedUpFromActivity_ActivityTypeEnum ActivityType) {
    ...
    // CallType
    @XStreamConverter(PicklistEnumConverter.class)
    private LookedUpFromActivity_CallTypeEnum CallType;

    @JsonProperty("CallType")
    public LookedUpFromActivity_CallTypeEnum getCallType() {
        return this.CallType;
    }

    @JsonProperty("CallType")
    public void setCallType(LookedUpFromActivity_CallTypeEnum CallType) {
