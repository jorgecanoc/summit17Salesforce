 ...
 */
public enum CampaignFeed_TypeEnum {
    ...
    private CampaignFeed_TypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static CampaignFeed_TypeEnum fromValue(String value) {
        for (CampaignFeed_TypeEnum e : CampaignFeed_TypeEnum.values()) {
