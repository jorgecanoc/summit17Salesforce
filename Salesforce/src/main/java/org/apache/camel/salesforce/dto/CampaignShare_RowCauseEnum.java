 ...
 */
public enum CampaignShare_RowCauseEnum {
    ...
    private CampaignShare_RowCauseEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static CampaignShare_RowCauseEnum fromValue(String value) {
        for (CampaignShare_RowCauseEnum e : CampaignShare_RowCauseEnum.values()) {
