 ...
 */
public enum ContactFeed_TypeEnum {
    ...
    private ContactFeed_TypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static ContactFeed_TypeEnum fromValue(String value) {
        for (ContactFeed_TypeEnum e : ContactFeed_TypeEnum.values()) {
