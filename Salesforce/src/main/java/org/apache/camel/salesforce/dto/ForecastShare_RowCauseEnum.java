 ...
 */
public enum ForecastShare_RowCauseEnum {
    ...
    private ForecastShare_RowCauseEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static ForecastShare_RowCauseEnum fromValue(String value) {
        for (ForecastShare_RowCauseEnum e : ForecastShare_RowCauseEnum.values()) {
