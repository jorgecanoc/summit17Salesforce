 ...
 */
public enum summit__Feed_TypeEnum {
    ...
    private summit__Feed_TypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static summit__Feed_TypeEnum fromValue(String value) {
        for (summit__Feed_TypeEnum e : summit__Feed_TypeEnum.values()) {
