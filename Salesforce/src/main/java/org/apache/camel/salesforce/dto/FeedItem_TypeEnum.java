...
public enum FeedItem_TypeEnum {
    ...
    private FeedItem_TypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static FeedItem_TypeEnum fromValue(String value) {
        for (FeedItem_TypeEnum e : FeedItem_TypeEnum.values()) {
