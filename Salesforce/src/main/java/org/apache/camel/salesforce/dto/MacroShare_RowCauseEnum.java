 ...
 */
public enum MacroShare_RowCauseEnum {
    ...
    private MacroShare_RowCauseEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static MacroShare_RowCauseEnum fromValue(String value) {
        for (MacroShare_RowCauseEnum e : MacroShare_RowCauseEnum.values()) {
