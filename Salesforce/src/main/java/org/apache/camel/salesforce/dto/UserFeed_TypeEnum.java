...
public enum UserFeed_TypeEnum {
    ...
    private UserFeed_TypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static UserFeed_TypeEnum fromValue(String value) {
        for (UserFeed_TypeEnum e : UserFeed_TypeEnum.values()) {
