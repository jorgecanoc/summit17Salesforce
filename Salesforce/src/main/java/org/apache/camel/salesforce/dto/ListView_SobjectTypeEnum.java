 ...
 */
public enum ListView_SobjectTypeEnum {
    ...
    private ListView_SobjectTypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static ListView_SobjectTypeEnum fromValue(String value) {
        for (ListView_SobjectTypeEnum e : ListView_SobjectTypeEnum.values()) {
