 ...
 */
public enum AssetShare_RowCauseEnum {
    ...
    private AssetShare_RowCauseEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static AssetShare_RowCauseEnum fromValue(String value) {
        for (AssetShare_RowCauseEnum e : AssetShare_RowCauseEnum.values()) {
