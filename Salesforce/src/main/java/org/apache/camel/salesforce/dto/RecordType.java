...
public class RecordType extends AbstractSObjectBase {
    ...
    private RecordType_SobjectTypeEnum SobjectType;

    @JsonProperty("SobjectType")
    public RecordType_SobjectTypeEnum getSobjectType() {
        return this.SobjectType;
    }

    @JsonProperty("SobjectType")
    public void setSobjectType(RecordType_SobjectTypeEnum SobjectType) {
