 ...
 */
public enum ReportFeed_TypeEnum {
    ...
    private ReportFeed_TypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static ReportFeed_TypeEnum fromValue(String value) {
        for (ReportFeed_TypeEnum e : ReportFeed_TypeEnum.values()) {
