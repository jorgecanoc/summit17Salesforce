...
/**
 * Salesforce DTO for SObject summit__Feed
 */
@XStreamAlias("summit__Feed")
public class summit__Feed extends AbstractSObjectBase {
    ...
    private summit__Feed_TypeEnum Type;

    @JsonProperty("Type")
    public summit__Feed_TypeEnum getType() {
        return this.Type;
    }

    @JsonProperty("Type")
    public void setType(summit__Feed_TypeEnum Type) {
        this.Type = Type;
    }
