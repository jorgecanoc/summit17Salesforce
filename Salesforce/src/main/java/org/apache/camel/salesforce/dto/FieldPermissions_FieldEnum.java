 ...
 */
public enum FieldPermissions_FieldEnum {
    ...
    // Product2.DisplayUrl
    PRODUCT2_DISPLAYURL("Product2.DisplayUrl"),
    // Product2.ExternalDataSource
    PRODUCT2_EXTERNALDATASOURCE("Product2.ExternalDataSource"),
    // Product2.ExternalId
    PRODUCT2_EXTERNALID("Product2.ExternalId"),
    // Product2.Family
    PRODUCT2_FAMILY("Product2.Family"),
    // Product2.ProductCode
    PRODUCT2_PRODUCTCODE("Product2.ProductCode"),
    // Product2.QuantityUnitOfMeasure
    PRODUCT2_QUANTITYUNITOFMEASURE("Product2.QuantityUnitOfMeasure"),
    ...
    private FieldPermissions_FieldEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static FieldPermissions_FieldEnum fromValue(String value) {
        for (FieldPermissions_FieldEnum e : FieldPermissions_FieldEnum.values()) {
