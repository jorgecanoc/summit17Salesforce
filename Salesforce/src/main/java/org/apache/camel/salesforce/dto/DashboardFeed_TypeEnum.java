 ...
 */
public enum DashboardFeed_TypeEnum {
    ...
    private DashboardFeed_TypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static DashboardFeed_TypeEnum fromValue(String value) {
        for (DashboardFeed_TypeEnum e : DashboardFeed_TypeEnum.values()) {
