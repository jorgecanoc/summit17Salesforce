 ...
 */
public enum AccountFeed_TypeEnum {
    ...
    private AccountFeed_TypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static AccountFeed_TypeEnum fromValue(String value) {
        for (AccountFeed_TypeEnum e : AccountFeed_TypeEnum.values()) {
