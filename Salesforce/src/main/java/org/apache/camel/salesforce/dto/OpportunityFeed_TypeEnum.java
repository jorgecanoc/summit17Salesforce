 ...
 */
public enum OpportunityFeed_TypeEnum {
    ...
    private OpportunityFeed_TypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static OpportunityFeed_TypeEnum fromValue(String value) {
        for (OpportunityFeed_TypeEnum e : OpportunityFeed_TypeEnum.values()) {
