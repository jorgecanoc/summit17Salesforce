 ...
 */
public enum CaseShare_RowCauseEnum {
    ...
    private CaseShare_RowCauseEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static CaseShare_RowCauseEnum fromValue(String value) {
        for (CaseShare_RowCauseEnum e : CaseShare_RowCauseEnum.values()) {
