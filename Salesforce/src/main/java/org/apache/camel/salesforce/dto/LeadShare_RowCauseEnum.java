 ...
 */
public enum LeadShare_RowCauseEnum {
    ...
    private LeadShare_RowCauseEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static LeadShare_RowCauseEnum fromValue(String value) {
        for (LeadShare_RowCauseEnum e : LeadShare_RowCauseEnum.values()) {
