 ...
 */
public enum TopicFeed_TypeEnum {
    ...
    private TopicFeed_TypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static TopicFeed_TypeEnum fromValue(String value) {
        for (TopicFeed_TypeEnum e : TopicFeed_TypeEnum.values()) {
