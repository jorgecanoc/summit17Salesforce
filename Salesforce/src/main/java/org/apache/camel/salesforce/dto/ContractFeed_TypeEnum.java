 ...
 */
public enum ContractFeed_TypeEnum {
    ...
    private ContractFeed_TypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static ContractFeed_TypeEnum fromValue(String value) {
        for (ContractFeed_TypeEnum e : ContractFeed_TypeEnum.values()) {
