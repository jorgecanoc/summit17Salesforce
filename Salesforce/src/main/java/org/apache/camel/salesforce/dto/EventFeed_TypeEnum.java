 ...
 */
public enum EventFeed_TypeEnum {
    ...
    private EventFeed_TypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static EventFeed_TypeEnum fromValue(String value) {
        for (EventFeed_TypeEnum e : EventFeed_TypeEnum.values()) {
