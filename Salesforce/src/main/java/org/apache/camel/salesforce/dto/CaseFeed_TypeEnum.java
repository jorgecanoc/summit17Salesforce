...
public enum CaseFeed_TypeEnum {
    ...
    private CaseFeed_TypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static CaseFeed_TypeEnum fromValue(String value) {
        for (CaseFeed_TypeEnum e : CaseFeed_TypeEnum.values()) {
