 ...
 */
public enum DashboardComponentFeed_TypeEnum {
    ...
    private DashboardComponentFeed_TypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static DashboardComponentFeed_TypeEnum fromValue(String value) {
        for (DashboardComponentFeed_TypeEnum e : DashboardComponentFeed_TypeEnum.values()) {
