...
public class ContentVersion extends AbstractSObjectBase {
    ...
    // FeaturedContentDate
    private java.time.ZonedDateTime FeaturedContentDate;

    @JsonProperty("FeaturedContentDate")
    public java.time.ZonedDateTime getFeaturedContentDate() {
        return this.FeaturedContentDate;
    }

    @JsonProperty("FeaturedContentDate")
    public void setFeaturedContentDate(java.time.ZonedDateTime FeaturedContentDate) {
