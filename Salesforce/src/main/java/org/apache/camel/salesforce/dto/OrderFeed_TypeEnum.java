 ...
 */
public enum OrderFeed_TypeEnum {
    ...
    private OrderFeed_TypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static OrderFeed_TypeEnum fromValue(String value) {
        for (OrderFeed_TypeEnum e : OrderFeed_TypeEnum.values()) {
