 ...
 */
public enum SolutionFeed_TypeEnum {
    ...
    private SolutionFeed_TypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static SolutionFeed_TypeEnum fromValue(String value) {
        for (SolutionFeed_TypeEnum e : SolutionFeed_TypeEnum.values()) {
