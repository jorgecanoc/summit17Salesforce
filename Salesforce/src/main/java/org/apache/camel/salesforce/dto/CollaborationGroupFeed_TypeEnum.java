 ...
 */
public enum CollaborationGroupFeed_TypeEnum {
    ...
    private CollaborationGroupFeed_TypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static CollaborationGroupFeed_TypeEnum fromValue(String value) {
        for (CollaborationGroupFeed_TypeEnum e : CollaborationGroupFeed_TypeEnum.values()) {
