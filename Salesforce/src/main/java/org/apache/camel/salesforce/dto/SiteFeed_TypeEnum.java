...
public enum SiteFeed_TypeEnum {
    ...
    private SiteFeed_TypeEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static SiteFeed_TypeEnum fromValue(String value) {
        for (SiteFeed_TypeEnum e : SiteFeed_TypeEnum.values()) {
